      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-display font-bold text-primary">{restaurant.name}</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/menu" className="text-muted-foreground/80 hover:text-primary transition-colors">Our Menu</Link></li>
              <li><Link href="/reservations" className="text-muted-foreground/80 hover:text-primary transition-colors">Book a Table</Link></li>
              <li><Link href="/contact" className="text-muted-foreground/80 hover:text-primary transition-colors">Contact Us</Link></li>
            </ul>
          </div>
