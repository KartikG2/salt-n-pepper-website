    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4 p-6 bg-card border border-border rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <div>
                ...
                <p className="text-muted-foreground font-mono text-lg">{restaurant.phone}</p>
          ...
          {/* Map */}
          <div className="h-[400px] md:h-full min-h-[400px] rounded-2xl overflow-hidden shadow-lg border border-border bg-muted relative">
            <iframe 
