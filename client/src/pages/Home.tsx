        ...
        <div className="container-custom relative z-10 text-center text-white space-y-6 max-w-4xl">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/menu">
                <Button size="lg" className="w-full sm:w-auto h-14 px-8 text-lg rounded-full bg-primary hover:bg-primary/90 text-white border-0 shadow-lg shadow-primary/30">
                  Order Now
                </Button>
              </Link>
              <Link href="/reservations">
                <Button variant="outline" size="lg" className="w-full sm:w-auto h-14 px-8 text-lg rounded-full bg-white/10 hover:bg-white/20 text-white border-white/30 backdrop-blur-sm">
                  Book a Table
                </Button>
              </Link>
            </div>
      ...
      <section className="py-20 bg-secondary/5">
        <div className="container-custom">
          <div className="flex justify-between items-end mb-12">
            <div>
              <span className="text-primary font-bold tracking-wider uppercase text-sm">Our Specialties</span>
              <h2 className="text-3xl md:text-4xl font-display font-bold mt-2">Popular Dishes</h2>
            </div>
            <Link href="/menu" className="hidden md:flex items-center text-primary font-semibold hover:translate-x-1 transition-transform">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {[
              ...
              <div key={i} className="group bg-card rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <Link href="/menu">
                    <Button variant="ghost" className="p-0 h-auto text-primary hover:text-primary/80 hover:bg-transparent font-semibold">
                      Order Now
                    </Button>
                  </Link>
                </div>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container-custom">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            <div>
              <h2 className="text-3xl font-display font-bold mb-4">Visit Us Today!</h2>
